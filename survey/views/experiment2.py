...
class Experiment2Step1(View):
    def get(self, request):
        ...
        return render(request, 'experiment2_step1.html', {'form': form})
...
class Experiment2Step2(View):
    def get(self, request):
        ...
        return render(request, 'experiment2_step2.html', {'form': form})
